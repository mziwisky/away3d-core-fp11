package away3d.tools.helpers
{
	...
	import away3d.animators.SpriteSheetAnimationState;
	...
	public class SpriteSheetHelper
	{
		...
		public function generateAnimationSet(animID:String, cols:uint, rows:uint, mapCount:uint = 1, from:uint = 0, to:uint = 0) : SpriteSheetAnimationSet
		{
			...
			var spriteSheetAnimationState:SpriteSheetAnimationState = new SpriteSheetAnimationState(node);
			spriteSheetAnimationSet.addState(animID, spriteSheetAnimationState);
